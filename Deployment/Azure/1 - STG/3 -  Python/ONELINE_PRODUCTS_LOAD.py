...
con = create_context(host = "tdprd2.td.teradata.com", username = str(td_userID), password=str(td_password) ,logmech = "LDAP")
...
print("Done:The data has been successfully inserted into the table. Please log in to the database to verify the accuracy of the data")
print('#####################################################################')