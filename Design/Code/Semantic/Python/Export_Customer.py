...
Export_Sql="SEL * FROM MP255078.CORE_AZURE_RETAIL_CUSTOMER WHERE CURR_IND = 'Y'"
with teradatasql.connect(host="tdprd.td.teradata.com", user="AR186005",password="******" ,logmech = "LDAP") as connect:
